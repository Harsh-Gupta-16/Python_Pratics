...
wait()
Select(browser.find_element_by_id("ctl00_MainContent_DropDownList1")).select_by_value("78")
wait()
# Selecting the previous month
#browser.find_element_by_xpath('//*[@id="ctl00_MainContent_Calendar1"]/tbody/tr[1]/td/table/tbody/tr/td[1]/a').click()
#wait()
# Selecting the date
browser.find_element_by_xpath('//*[@title="' + sys.argv[1] + '"]').click()
wait()
with open('C:\\RL_automate\\TaskS.csv') as csvfile:
