...
with open('C:\\RL_automate\\Task.csv') as csvfile:
    ...
    for row in csvReader:
        ...
        if row['Application'] == 'Billing EDI':
            Select(browser.find_element_by_id(
                "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlApplication")).select_by_value("5")
            # break
        ...
        if row['Activity'] == 'Production Support - IM activities':
            ...
            wait()
            if row['SubActivity'] == 'Enhancement':
                Select(browser.find_element_by_id(
                ...
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("3G")
            elif row['SubActivity'] == 'Analysis & Design':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("3H")
            elif row['SubActivity'] == 'Coding':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("3I")
            elif row['SubActivity'] == 'Testing':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("3J")
            elif row['SubActivity'] == 'Implementation':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("3K")
            elif row['SubActivity'] == 'Post Implementation':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("3L")

            # break
        elif row['Activity'] == 'Enhancements greater than 80 hour':
            Select(browser.find_element_by_id(
                "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_type")).select_by_value("4")
            wait()
            if row['SubActivity'] == 'Enhancement':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("4A")
            elif row['SubActivity'] == 'Customer meeting':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("4B")
            elif row['SubActivity'] == 'Documentation':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("4C")
            elif row['SubActivity'] == 'Knowledge Transition from Quest':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("4D")
            elif row['SubActivity'] == 'PI Activity':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("4E")
            elif row['SubActivity'] == 'Internal Meeting':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("4F")
            elif row['SubActivity'] == 'Requirement Finalization':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("4G")
            elif row['SubActivity'] == 'Analysis & Design':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("4H")
            elif row['SubActivity'] == 'Coding':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("4I")
            elif row['SubActivity'] == 'Testing':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("4J")
            elif row['SubActivity'] == 'Implementation':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("4K")
            elif row['SubActivity'] == 'Post Implementation':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("4L")
        elif row['Activity'] == 'Others':
            Select(browser.find_element_by_id(
            ...
            elif row['SubActivity'] == 'Late due to cab delay':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("6G")
            elif row['SubActivity'] == 'Internal Meeting':
                Select(browser.find_element_by_id(
                    "ctl00_MainContent_Gridview1_ctl" + '%02d' % count + "_ddlActivity_Subtype")).select_by_value("6H")
                # break
        # adding Description
