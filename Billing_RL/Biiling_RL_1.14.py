...
# Version 1.14 copy file to achieve folder and
...
cmd = 'if exist Billing_Resource_loading_*.xls ( del C:\\Billing_RL\\inprogress\\Billing_Resource_loading_*.xls )'
os.system(cmd)
...
cmd = 'copy Billing_Resource_loading_*xls C:\\Billing_RL\\Archive'
os.system(cmd)
