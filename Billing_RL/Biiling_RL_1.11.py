...
# Version 1.11 - Adding onsite Links
...
links_offsite = ["http://qdcws3206.us.qdx.com/billingteam1/", "http://qdcws3206.us.qdx.com/billingteam2/",
                 "http://qdcws3206.us.qdx.com/billingteam3/", "http://qdcws3206.us.qdx.com/billingteam4/"]

links_onsite = ["http://10.43.8.164/ResourceUtilizationBillingone/ReportByName.aspx",
...
sender_passwd = str(input('Enter the Email id password: '))
...
# Generating Offiste Report
def generate_report_offsite():
...
# Generating Onsite report
def generate_report_onsite():
    # selecting all the resources
    browser.find_element_by_id('ctl00_MainContent_chkAll').click()
    # selecting all the activity type
    browser.find_element_by_id('ctl00_MainContent_CheckBox1').click()
...
for link in links_offsite:
    browser.get(link)
    browser.implicitly_wait(10)
    generate_report_offsite()
    browser.implicitly_wait(20)

# calling the onsite billing url
for link in links_onsite:
    browser.get(link)
    browser.implicitly_wait(10)
    generate_report_onsite()
    browser.implicitly_wait(20)
