...
echo.
%pythn% %pip% install --trusted-host pypi.python.org --trusted-host files.pythonhosted.org --trusted-host pypi.org pandas

echo -  Installing XLWT Package
echo.
%pythn% %pip% install --trusted-host pypi.python.org --trusted-host files.pythonhosted.org --trusted-host pypi.org xlwt

echo -  Installing Selenium Package
echo.
%pythn% %pip% install --trusted-host pypi.python.org --trusted-host files.pythonhosted.org --trusted-host pypi.org selenium

echo -  Installing Beautiful Soup Package
echo.
%pythn% %pip% install --trusted-host pypi.python.org --trusted-host files.pythonhosted.org --trusted-host pypi.org bs4

echo -  Installing LXML Package
echo.
%pythn% %pip% install --trusted-host pypi.python.org --trusted-host files.pythonhosted.org --trusted-host pypi.org lxml

echo -  Installing Shutil Package
echo.
%pythn% %pip% install --trusted-host pypi.python.org --trusted-host files.pythonhosted.org --trusted-host pypi.org pytest-shutil

echo -  Installing Win32 Package
echo.
%pythn% %pip% install --trusted-host pypi.python.org --trusted-host files.pythonhosted.org --trusted-host pypi.org pywin32

echo -  Installing ODBC Package
echo.
%pythn% %pip% install --trusted-host pypi.python.org --trusted-host files.pythonhosted.org --trusted-host pypi.org pyodbc

Echo ===================^> All Package Installed ^<==========================
Echo. 
Echo ===================^> Downlaod Web Driver ^<==========================
start https://chromedriver.storage.googleapis.com/91.0.4472.19/chromedriver_win32.zip
...
Echo C:\Billing_RL\Python39\python.exe C:\Billing_RL\Billing_userdetails.py >> C:\Billing_RL\Run.Bat
